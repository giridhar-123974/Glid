            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  />
                  <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-[#16A34A] text-white flex items-center justify-center text-[10px] font-bold border-2 border-white">
                    ✓
                  </div>
                </div>
                <div>
                  <div className="flex items-center gap-1.5">
                    <h3 className="text-base font-black text-[#0F172A] tracking-tight">{activePro.name}</h3>
                    <span className="px-2 py-0.5 rounded-full bg-orange-50 text-[#FF6B00] text-[10px] font-black">
                      {activePro.trustScore}% Trust
                    </span>
                  </div>
                  <p className="text-xs text-gray-500 font-medium line-clamp-1">{activePro.headline}</p>
                  <span className="text-[11px] text-gray-400 flex items-center gap-1 mt-0.5">
                    <MapPin className="w-3 h-3 text-[#FF6B00]" /> {activePro.cityArea}, {activePro.location} • {activePro.distanceKm} km away
                  </span>
                </div>
              </div>
