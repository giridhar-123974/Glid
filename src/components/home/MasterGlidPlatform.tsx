...
export default function MasterGlidPlatform() {
  ...
  return (
    <div className="w-full bg-[#FAFBFC] text-[#0F172A] selection:bg-orange-100 selection:text-[#FF6B00]">
      ...
      {/* ========================================================================= */}
      {/* 20. FINAL HIGH-CONVERSION CTA (Compact Apple-Style Two-Column Banner) */}
      {/* ========================================================================= */}
      <section className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <div className="bg-[#0B1220] rounded-3xl p-6 sm:p-8 lg:p-10 text-white shadow-xl relative overflow-hidden border border-white/10">
          
          {/* Subtle Ambient Glow */}
          <div className="absolute -top-20 -right-20 w-72 h-72 bg-orange-500/15 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            {/* LEFT COLUMN: Pitch, 5 Trust Bullets, CTAs, Live Stats */}
            <div className="lg:col-span-7 space-y-4">
              
              <div className="space-y-1.5">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-orange-500/20 text-[#FF6B00] text-[10px] font-black tracking-wider uppercase border border-orange-500/30">
                  <Sparkles className="w-2.5 h-2.5" />
                  <span>START IN 60 SECONDS</span>
                </div>
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-black tracking-tight leading-snug">
                  Ready to Hire Verified Specialists <br className="hidden sm:inline" />
                  <span className="bg-gradient-to-r from-[#FF6B00] to-amber-400 bg-clip-text text-transparent">
                    With Zero Risk?
                  </span>
                </h2>
                <p className="text-xs sm:text-sm text-gray-300 font-medium leading-relaxed max-w-lg">
                  Join 60,000+ verified specialists, creators, and businesses across India on GLID.
                </p>
              </div>

              {/* 5 Trust Bullets */}
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-1 text-[11px] font-semibold text-gray-200">
                <div className="flex items-center gap-1.5">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 pt-1">
                <Link
                  href="/explore"
                  className="px-5 py-2.5 rounded-xl bg-[#FF6B00] hover:bg-[#E55F00] active:scale-95 text-white font-bold text-xs shadow-md shadow-orange-500/25 transition-all flex items-center justify-center gap-1.5"
                >
                ...
                <button
                  type="button"
                  onClick={() => openOnboarding('professional')}
                  className="px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/15 active:scale-95 text-white font-bold text-xs border border-white/20 transition-all flex items-center justify-center gap-1.5"
                >
              ...
              {/* 4 Live Stats Strip */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-3.5 border-t border-white/10 text-center">
                <div>
                  <span className="text-sm sm:text-base font-black text-white block">60,000+</span>
                  <span className="text-[9px] text-gray-400 font-semibold">Professionals</span>
                </div>
                <div>
                  <span className="text-sm sm:text-base font-black text-white block">250+</span>
                  <span className="text-[9px] text-gray-400 font-semibold">Categories</span>
                </div>
                <div>
                  <span className="text-sm sm:text-base font-black text-[#16A34A] block">98%</span>
                  <span className="text-[9px] text-gray-400 font-semibold">Success Rate</span>
                </div>
                <div>
                  <span className="text-sm sm:text-base font-black text-amber-400 block">4.9★</span>
                  <span className="text-[9px] text-gray-400 font-semibold">Customer Rating</span>
                </div>
              </div>

            </div>

            {/* RIGHT COLUMN: Layered Apple-Style Glass Visual Mockup */}
            <div className="lg:col-span-5 relative">
              <div className="p-4 sm:p-5 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/15 shadow-xl space-y-2.5 relative">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  ...
                  <span className="text-[9px] font-bold text-gray-400">
                    glid.network • live dispatch
                  </span>
                </div>

                {/* Floating Specialist Card */}
                <div className="p-2.5 rounded-xl bg-white/10 border border-white/15 flex items-start gap-2.5">
                  <div className="relative w-9 h-9 flex-shrink-0">
                    ...
                    />
                    <div className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full bg-[#16A34A] text-white flex items-center justify-center text-[8px] font-bold border border-[#0B1220]">
                      ✓
                    </div>
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <h4 className="text-[11px] font-black text-white truncate">Priya Sharma</h4>
                      <span className="text-[9px] font-black text-[#FF6B00]">99% Trust</span>
                    </div>
                    <p className="text-[10px] text-gray-300 font-medium truncate">Lead UI/UX & Design Systems</p>
                    <span className="text-[9px] text-gray-400 font-semibold block mt-0.5">
                      Banjara Hills • 1.4 km away
                    </span>
                  </div>
                </div>

                {/* Live Escrow Balance Capsule */}
                <div className="p-2.5 rounded-xl bg-gradient-to-r from-orange-500/20 to-amber-500/10 border border-orange-500/30 flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    <Lock className="w-3.5 h-3.5 text-[#FF6B00]" />
                    <div>
                      <span className="text-[9px] text-gray-300 block font-medium">Escrow Vault Active</span>
                      <span className="text-[11px] font-black text-white">₹45,000 Protected</span>
                    </div>
                  </div>
                ...
                {/* Radar & ETA Status Pill */}
                <div className="flex items-center justify-between text-[10px] font-bold text-gray-300 px-1 pt-0.5">
                  <span className="flex items-center gap-1 text-blue-400">
                    <Bike className="w-3 h-3" />
                    <span>~7 mins ETA (En Route)</span>
                  </span>
